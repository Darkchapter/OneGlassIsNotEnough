...
class WinesControllerTest < ActionController::TestCase
  ...
  test "should create wine" do
    assert_difference('Wine.count') do
      post :create, wine: { description: @wine.description, name: @wine.name, photo_url: @wine.photo_url, rating: @wine.rating }
    end
  ...
  test "should update wine" do
    patch :update, id: @wine, wine: { description: @wine.description, name: @wine.name, photo_url: @wine.photo_url, rating: @wine.rating }
    assert_redirected_to wine_path(assigns(:wine))
  end
